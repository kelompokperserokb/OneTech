...
$(document).ready(function() {
    ...
    function printAddProduct(listMerk, listCategory, index){
		var row = '<tr>' +
			...
			'<td><input autocomplete="off" type="file" accept="image/jpeg,image/png" class="form-control" name="image-product1" id="image-product1" value=""><img id="preview-image1" src=""></td>' +
			'<td><input autocomplete="off" type="file" accept="image/jpeg,image/png" class="form-control" name="image-product2" id="image-product2" value=""><img id="preview-image2" src=""></td>' +
			'<td><input autocomplete="off" type="file" accept="image/jpeg,image/png" class="form-control" name="image-product3" id="image-product3" value=""><img id="preview-image3" src=""></td>' +
			'<td>' + addeditbutton + '</td>' +
			'<td>' + deletebutton + '</td>' +
			'</tr>';
		$("table").append(row);
					...
					success: function (response) {
						if (response.length != 0) {
							...
							if (data[0] != "error") {
								...
								$(button).parents("tr").find(".add, .edit").toggle();
							} else {
								alert(data[1]);
							}
						}
	...
	function printEditProduct(column, listOptionMerk, listOptionCategory, selectedOptionMerk, selectedOptionCategory){
		...
		$(column[7]).html('<input autocomplete="off" type="file" accept="image/jpeg,image/png" class="form-control" name="image-product1" id="image-product1" value="'+$(column[7]).find('img').attr('src')+'">');
		$(column[8]).html('<input autocomplete="off" type="file" accept="image/jpeg,image/png" class="form-control" name="image-product2" id="image-product2" value="'+$(column[8]).find('img').attr('src')+'">');
		$(column[9]).html('<input autocomplete="off" type="file" accept="image/jpeg,image/png" class="form-control" name="image-product3" id="image-product3" value="'+$(column[9]).find('img').attr('src')+'">');
