...
<body>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Order Logistic table</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Order Logistic Table</strong>
                            </div>
                            <div class="card-body">
	...
	<script src="<?php echo base_url(); ?>Asset/js/onetech/order/logistic_input.js"></script>
