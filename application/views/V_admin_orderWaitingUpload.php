...
<body>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Waiting Upload Order table</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Waiting Upload Order Table</strong>
                            </div>
                            <div class="card-body">
	...
	<script src="<?php echo base_url(); ?>Asset/js/onetech/order/order_waiting.js"></script>
