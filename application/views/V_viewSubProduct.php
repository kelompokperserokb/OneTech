		...
		<div class="row">
			<div class="col-md-12">
				...
				if($product['count'] == 0) {
					...
					$subcategory = $subcatname['data']['data_array'][0]->subcategory_name;

					echo '<div class="section-title">
						<h3>Product for ' .$subcategory. '</h3>
					</div>
			...
			<center class="paginationbox">
				<ul class="pagination">
					...
					echo "
                <li>
                	<a href='" . base_url() . "viewproduct/cat/" . $catid . "/subcat/" . $subcatid . "/1/'>
                		" . 'First Page' . "
                	</a>
                </li>
            ";
					for ($i = 1; $i <= $total_pages; $i++) {
						echo "
					<li>
						<a href='" . base_url() . "viewproduct/cat/" . $catid . "/subcat/" . $subcatid . "/" . $i . "/'>
                			" . $i . "
                		</a>
					</li>
				";
					...
					echo "
				<li>
					<a href='" . base_url() . "viewproduct/cat/" . $catid . "/subcat/" . $subcatid . "/" . $total_pages . "/'>
                		" . 'Last Page' . "
                	</a>
				</li>
			";
