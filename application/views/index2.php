...
<body>
    ...
    <div class="slideshow-container">
        ...
        <div class="mySlides faded">
            ...
            <img src="<?php echo base_url(); ?>Asset/img/slider/slider-1.jpg" style="width:100%">
            <div class="text"></div>
            </div>

        <div class="mySlides faded">
            <div class="numbertext">2 / 3</div>
            <img src="<?php echo base_url(); ?>Asset/img/slider/slider-2.jpg" style="width:100%">
            <div class="text"></div>
        </div>

        <div class="mySlides faded">
            <div class="numbertext">3 / 3</div>
            <img src="<?php echo base_url(); ?>Asset/img/slider/slider-3.jpg" style="width:100%">
            <div class="text"></div>
        </div>
